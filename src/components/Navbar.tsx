...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-white border-gray-200 dark:bg-gray-900" ref={burgerMenuRef}>
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="https://twitter.com/fabled_btc" className="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span className="self-center text-2xl font-semibold whitespace-nowrap text-gray-900  dark:text-white"> XXVI
            </span>
          </a>
          <div className="flex-1 hidden w-full md:block md:w-auto" id="navbar-default">
            <ul className="font-medium flex md:flex-row justify-end">
              <li className="flex items-center m-0">
                <a href="/" className="block py-2 px-3.5 dark:text-white text-gray-900 bg-transparent" aria-current="page">Home</a>
              </li>
              <li className="flex items-center m-0">
                <a href="/auctions" className="block py-2 px-3.5 text-gray-900 rounded border-0  dark:text-white" >Auction</a>
              </li>
              {/* <li>
